...
import { ensureDashboardSeed, insertLocation } from "@/lib/dashboard-data"
import {
  Alert,
  AlertDescription,
  AlertTitle,
  ...
  const handleCreateLocation = () => {
    ...
    const nextLocation: AttendanceLocationRecord = {
      ...
      try {
        ...
        await insertLocation(supabase, nextLocation)
        setAlert({ type: "success", message: `Location "${name.trim()}" created successfully.` })
        setTimeout(() => {
          setAlert(null)
