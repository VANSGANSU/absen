...
const REMEMBER_EMAIL_KEY = "absensi.remembered-email"
...
export function SignInPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setAlert({
        tone: "error",
        message: "Tidak dapat memulai login Google saat ini.",
      })
    } finally {
  ...
  return (
    <AuthShell modeLabel="Login" title="Login to Your Account">
      <button
        type="button"
