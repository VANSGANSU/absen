...
export default async function DashboardLayout(props: LayoutProps<"/dashboard">) {
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        <header className="sticky top-0 z-10 flex min-h-16 shrink-0 items-center border-b border-slate-200 bg-white py-3">
        ...
        <div className="dashboard-ui flex flex-1 flex-col gap-4 bg-[#fafafa] p-3 sm:gap-6 sm:p-6">
          {props.children}
        </div>
      </SidebarInset>
    </SidebarProvider>
