...
export default function TimeActivityReportPage() {
  return (
    <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed border-slate-200 bg-white p-8 text-center shadow-sm">
      <div className="flex flex-col items-center gap-3">
        <Clock3 className="size-10 text-slate-300" />
        <h2 className="text-xl font-semibold text-slate-900">Time & Activity Report Coming Soon</h2>
